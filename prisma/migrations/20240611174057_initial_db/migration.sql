...
CREATE TABLE "inviteds" (
    ...
    CONSTRAINT "inviteds_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "inviteds" ADD CONSTRAINT "inviteds_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
